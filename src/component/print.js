...
const status_delivered =  <div>
            ...
            const status_orderconfirmed =  <div>
                 ...
                 <div className="col-3  d-flex icon-content"> <img className="icon" src="https://i.imgur.com/9nnc9Et.png" style={{height:'2rem', width:'2rem'}}/>
                <div className="d-flex flex-column">
                    <p className="font-weight-bold text-success">Order<br/>Processed</p>
                </div>
            </div>
            <div className=" col-3 d-flex icon-content"> <img className="icon" src="https://i.imgur.com/u1AzR7w.png" style={{height:'2rem', width:'2rem'}}/>
                <div className="d-flex flex-column">
                    <p className="font-weight-bold text-dark">Order<br/>Shipped</p>
                </div>
            </div>
            <div className="col-3  d-flex icon-content"> <img className="icon" src="https://i.imgur.com/TkPm63y.png" style={{height:'2rem', width:'2rem'}}/>
                <div className="d-flex flex-column ">
                    <p className="font-weight-bold text-dark ">Order<br/>In Route</p>
                </div>
            </div>
            <div className="col-3  d-flex icon-content"> <img className="icon" src="https://i.imgur.com/HdsziHP.png" style={{height:'2rem', width:'2rem'}}/>
                <div className="d-flex flex-column ">
    ...
    <div className=" ">
        <div className=" ">
                 ...
                 <div className="invoice p-3" id='print'>
                  	<div className='row p-2 mx-auto'>
                  		<h4 className="my-0 mr-md-auto   font-weight-normal font-weight-bold  float-left" style={{ color: '#343A40' }}>
                        	<span className="badge badge-dark mar">ECG.ai</span></h4>
                	</div>

      		 <div className="row ">
              <div className="col-8 ">
                    <h5> {this.state.order_status}!</h5> <span className="font-weight-bold d-block mt-4">Hello,{sessionStorage.getItem('id')}</span> <span>You order has been confirmed and will be shipped in next two days!</span>
            ...
            <div className="col-12">
            	<h5 className='m-2 text-muted' > Order Status:</h5>
